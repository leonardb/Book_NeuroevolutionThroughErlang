...
%% When gen/2 is executed it spawns the neuron element and immediately begins to
...
%% which the neuron then adds the bias and executes the activation function. After fanning out the
...
%% The MInput_PIdPs will contain an modified version of the weights once the training/learning
%% algorithm has been added to the system.
